...
# debian-iso-builder-remix-cinnamon
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/debian-iso-builder-remix-cinnamon/tree/main/profile/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/debian-iso-builder-remix-cinnamon/tree/main/profile/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/debian-iso-builder-remix-cinnamon/tree/main/profile/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [debian-iso-builder-remix-cinnamon](https://github.com/samwhelp/debian-iso-builder-remix-cinnamon)

``` sh
git clone https://github.com/samwhelp/debian-iso-builder-remix-cinnamon.git
```


> change dir to `debian-iso-builder-remix-cinnamon`

``` sh
cd debian-iso-builder-remix-cinnamon
```
...
> change dir to `~/work/debian-iso-builder-remix-cinnamon/iso-profile`

``` sh
cd ~/work/debian-iso-builder-remix-cinnamon/iso-profile
```
...
> The resulting ISO file will be placed on `~/work/debian-iso-builder-remix-cinnamon/iso-profile/dist`
